...
class WeatherScreend extends StatefulWidget {
  const WeatherScreend({super.key});

  @override
  State<WeatherScreend> createState() => _WeatherScreenState();
}

class _WeatherScreenState extends State<WeatherScreend> {
  ...
  void initState() {
    super.initState();
    weather = getCurrentWeather('Delhi');
  }
